...
int initManagerAndAirline(AirportManager* pManager, Airline* pCompany, const char* airlineFileName, int isComp)
{
	...
	if (res == FROM_FILE)
		return initAirlineFromFile(pCompany, pManager, airlineFileName, isComp);
	else
